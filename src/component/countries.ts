...
const all: Country[] = allCountries.map(([ name, iso2, dialCode ]) => ({
  name,
...
export const getDefault = (country: string = 'us'): Country => all.filter(a => a.iso2 === country.trim().toUpperCase())[0]

export const getCountryByDialCode = (val: string = ''): Country|null => {
